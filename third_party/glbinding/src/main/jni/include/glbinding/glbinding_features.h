...
# define GLBINDING_COMPILER_IS_CrayClang 0
...
# define GLBINDING_COMPILER_IS_OrangeC 0
# define GLBINDING_COMPILER_IS_Renesas 0
...
# define GLBINDING_COMPILER_IS_TIClang 0
...
# define GLBINDING_COMPILER_IS_Diab 0
...
# undef GLBINDING_COMPILER_IS_CrayClang
# define GLBINDING_COMPILER_IS_CrayClang 1
...
# undef GLBINDING_COMPILER_IS_OrangeC
# define GLBINDING_COMPILER_IS_OrangeC 1

#elif defined(__RENESAS__)
# undef GLBINDING_COMPILER_IS_Renesas
# define GLBINDING_COMPILER_IS_Renesas 1
...
# undef GLBINDING_COMPILER_IS_TIClang
# define GLBINDING_COMPILER_IS_TIClang 1
...
# undef GLBINDING_COMPILER_IS_Diab
# define GLBINDING_COMPILER_IS_Diab 1
