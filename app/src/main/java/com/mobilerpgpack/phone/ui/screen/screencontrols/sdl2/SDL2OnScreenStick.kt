...
class SDL2OnScreenStick (engineType: EngineTypes,
    ...
    SDLOnScreenStick(engineType, stickType,offsetXPercent, offsetYPercent,
        sizePercent, alpha, defaultViewRenderRule = defaultViewRenderRule, controlsType, isDeleted, showInQuickPanel) {

    override val virtualControllerLibraryName: String get() = VIRTUAL_CONTROLLER_LIBRARY_NAME

    private companion object{
        private const val VIRTUAL_CONTROLLER_LIBRARY_NAME = "SDL2VirtualController"
    }
}