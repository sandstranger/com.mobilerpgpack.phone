...
val arxLibertatisOnScreenStickControlsLayout: Collection<IScreenControlsView> = listOf(
    ...
    SDL3ImageButton(
        "offer_quick_inventory_item",
        EngineTypes.ArxLibertatis,
        offsetXPercent = 0.52f,
        offsetYPercent = 0.03f,
        sizePercent = 0.055f,
        buttonResId = R.drawable.expense,
        sdlKeyEvent = KeyEvent.KEYCODE_N,
        isDeleted = true,
        controlsType = ControlsType.OnScreenStick,
    ),
    SDL3ImageButton(
        "use_quick_inventory_item",
        EngineTypes.ArxLibertatis,
        offsetXPercent = 0.52f,
        offsetYPercent = 0.03f,
        sizePercent = 0.055f,
        buttonResId = R.drawable.apple_core,
    ...
    SDL3ImageButton(
        ...
        offsetYPercent = 0.18f,
        sizePercent = 0.05f,
        buttonResId = R.drawable.wizard_staff,
